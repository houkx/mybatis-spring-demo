...
import org.apache.ibatis.custom.ArgedTransaction;
...
public abstract class BaseExecutor implements Executor {
	...
	protected Connection getConnection(Log statementLog) throws SQLException {
		...
		if (transaction instanceof ArgedTransaction && statementLog instanceof Slf4jImpl) {
			String daoMethod = ((Slf4jImpl) statementLog).getName();
			connection = ((ArgedTransaction) transaction).getConnection(daoMethod);
		} else {
