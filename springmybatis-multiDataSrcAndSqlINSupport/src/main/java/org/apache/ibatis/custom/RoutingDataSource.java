 ...
 *
 */
public class RoutingDataSource extends AbstractDataSource implements DataSourceGroup, InitializingBean {
	// String[] ds = new String[] { "slave", "master"/*, "slave"*/ };
	//
	// /*
	// * (non-Javadoc)
	// *
	...
	// String kds = ds[new Random().nextInt(ds.length)];
	// System.out.println("数据源:"+kds);
	// return kds;
	// }
	 ...
	 * apply if the lookup key was {@code null}. Lookup keys without a
	 ...
	 * names (to be resolved via a {@link #setDataSourceLookup
	 * DataSourceLookup}).
	 * 
	 * @param dataSource
	...
	protected DataSource determineTargetDataSource() {
		return determineTargetDataSource(null);
	}
	/**
